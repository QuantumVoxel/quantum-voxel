...
public interface BlockRenderer {
     ...
     */
    void renderNorth(TextureRegion region, float x1, float y1, float x2, float y2, float z, GreedyMesher.LightLevelData lightLevel, PerCornerLightData lightData, MeshPartBuilder builder);
     ...
     */
    void renderSouth(TextureRegion region, float x1, float y1, float x2, float y2, float z, GreedyMesher.LightLevelData lightLevel, PerCornerLightData lightData, MeshPartBuilder builder);
     ...
     */
    void renderWest(TextureRegion region, float z1, float y1, float z2, float y2, float x, GreedyMesher.LightLevelData lightLevel, PerCornerLightData lightData, MeshPartBuilder builder);
     ...
     */
    void renderEast(TextureRegion region, float z1, float y1, float z2, float y2, float x, GreedyMesher.LightLevelData lightLevel, PerCornerLightData lightData, MeshPartBuilder builder);
     ...
     */
    void renderTop(TextureRegion region, float x1, float z1, float x2, float z2, float y, GreedyMesher.LightLevelData lightLevel, PerCornerLightData lightData, MeshPartBuilder builder);
     ...
     */
    void renderBottom(TextureRegion region, float x1, float z1, float x2, float z2, float y, GreedyMesher.LightLevelData lightLevel, PerCornerLightData lightData, MeshPartBuilder builder);
}