...
//        if (player != null && context instanceof InGameControllerContext) {
//            InGameControllerContext inGameControllerContext = (InGameControllerContext) context;
...
//            switch (client.getPlayerView()) {
//                case FIRST_PERSON:
//                    playerView = PlayerView.THIRD_PERSON;
//                    break;
//                case THIRD_PERSON:
//                    playerView = PlayerView.THIRD_PERSON_FRONT;
//                    break;
...
//            }
//            client.setPlayerView(playerView);
...
//    }
//
//    public static final class EventObject<V, T extends Enum<T> & ControllerInterDynamic<V>> {
//        private final EventType<? extends T> type;
//        private final T mapping;
//        private final V value;
//
//        public EventObject(EventType<? extends T> type, T mapping,
//                           V value) {
//            this.type = type;
...
//        @Override
//        public int hashCode() {
//            return Objects.hash(type, mapping, value);
//        }
//
//        @Override
