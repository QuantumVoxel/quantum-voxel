...
import dev.ultreon.quantum.config.api.props.FloatProperty;

public class FloatEntry extends TextEntry {
    private boolean error;

    public FloatEntry(FloatProperty property) {
        super(100);
        ...
        withCallback((value) -> {
            ...
            try {
                property.setValue(Float.valueOf(value.getValue()));
