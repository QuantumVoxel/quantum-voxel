...
public class MemoryUsageOverlay extends Overlay {
    ...
    private final Color filling = new Color(0x202020ff);
    private final Color outline = new Color(0x303030ff);
    ...
    public void render(Renderer renderer, float deltaTime) {
        ...
        renderer.fill(x + 1, y, width + 4, height + 6, filling);
        renderer.fill(x, y + 1, width + 6, height + 4, filling);
        renderer.box(x + 1, y + 1, width + 4, height + 4, outline);
