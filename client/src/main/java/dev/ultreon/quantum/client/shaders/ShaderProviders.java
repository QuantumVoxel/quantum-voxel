...
public class ShaderProviders {
    /**
     * The depth shader provider. Located in {@code shaders/depth.vert} and {@code shaders/depth.frag}.
     *
     * @see DepthShaderProvider
     */
    public static final Supplier<DepthShaderProvider> DEPTH = ShaderProviders.register("depth", () -> new MyDepthShaderProvider(
     ...
     * @see ModelShaders
     */
    public static final Supplier<ModelShaders> MODEL_VIEW = ShaderProviders.register("model_view", () -> new ModelShaders(
     ...
     * @see GizmoShaders
     */
    public static final Supplier<GizmoShaders> GIZMO = ShaderProviders.register("gizmo", () -> new GizmoShaders(
     ...
     */
    public static final Supplier<GizmoOutlineShaders> GIZMO_OUTLINE = ShaderProviders.register("gizmo_outline", () -> new GizmoOutlineShaders(
