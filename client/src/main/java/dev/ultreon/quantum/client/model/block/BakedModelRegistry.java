...
public final class BakedModelRegistry implements Disposable {
    ...
    private final ImmutableMap<Block, List<Pair<Predicate<BlockData>, BakedCubeModel>>> bakedModels;

    public BakedModelRegistry(TextureAtlas atlas, ImmutableMap<Block, List<Pair<Predicate<BlockData>, BakedCubeModel>>> bakedModels) {
        this.atlas = atlas;
    ...
    public ImmutableMap<Block, List<Pair<Predicate<BlockData>, BakedCubeModel>>> bakedModels() {
