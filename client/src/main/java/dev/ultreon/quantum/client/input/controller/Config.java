...
//
//        Path bindingsDir = Path.of("config/quantum");
...
//        public ConfigButton(int w, Config config) {
//            super(w, 21);
//            this.text().set(TextObject.translation("quantum.open_config"));
//            this.setCallback(button -> new BindingsConfigScreen(QuantumClient.get().screen, config).open());
//        }
//    }
//
