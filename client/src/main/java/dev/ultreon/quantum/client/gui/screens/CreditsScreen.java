...
public class CreditsScreen extends TabbedUI {
    ...
    private class CreditWidget extends UIContainer<CreditWidget> {
        ...
        public CreditWidget(String name, Json5Object assetInfo) {
            ...
            if (assetInfo.has("url") && assetInfo.get("url").isJson5Primitive() && assetInfo.get("url").getAsJson5Primitive().isString()) add(TextButton.of("Open page", 80, 21).getCallback(btn -> {
            ...
            if (assetInfo.has("roles")) add(TextButton.of("View roles", 80, 21).getCallback(btn -> {
            ...
            if (assetInfo.has("for")) add(TextButton.of("Has made", 80, 21).getCallback(btn -> {
            ...
            if (assetInfo.has("description")) add(TextButton.of("View description", 80, 21).getCallback(btn -> {
            ...
            if (assetInfo.has("license")) add(TextButton.of("View license", 80, 21).getCallback(btn -> {
            ...
            if (assetInfo.has("links")) add(TextButton.of("View links", 80, 21).getCallback(btn -> {
