...
public class RenderType {
    private static final Array<RenderType> MANAGED = new Array<>();
    ...
    public static final RenderType GIZMO_OUTLINE = RenderType.builder(Position(), ColorPacked(), TexCoords(0))
            .name("gizmo_outline")
     ...
     */
    @Deprecated
    public static RenderType register(RenderType renderType) {
        return renderType;
    }

    public static RenderType[] values() {
        return MANAGED.toArray(RenderType.class);
    }

    public static RenderType byName(String renderPass) {
        RenderType pass = ClientRegistries.RENDER_PASS.get(new NamespaceID(CommonConstants.NAMESPACE, renderPass));
