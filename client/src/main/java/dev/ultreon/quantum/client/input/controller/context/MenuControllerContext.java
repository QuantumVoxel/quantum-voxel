...
//            && ((ContainerScreen) screen).isOnSlot()) {
...
//        if (!(client.screen instanceof ContainerScreen)) return false;
//        ContainerScreen containerScreen = (ContainerScreen) client.screen;
//        if (!(containerScreen.focused instanceof ItemSlotWidget)) return false;
//        ItemSlotWidget slot = (ItemSlotWidget) containerScreen.focused;
//
