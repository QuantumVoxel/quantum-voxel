...
public class TitleButton extends Button<TitleButton> {
    ...
    public void renderWidget(Renderer renderer, int mouseX, int mouseY, float deltaTime) {
        ...
        if (textObject != null) {
            ...
            renderer.line(x + 40, y + this.size.height - 30, x + this.size.width - 40, y + this.size.height - 30, this.enabled ? this.textColor.get().withAlpha(0x80) : this.textColor.get().withAlpha(0x40));
