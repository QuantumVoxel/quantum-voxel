...
import com.ultreon.quantum.client.config.entries.*;
import com.ultreon.quantum.client.config.gui.ConfigEntry;
import com.ultreon.quantum.client.util.DuplicateException;
...
public class Configuration {
    public static final FileHandle FILE = QuantumClient.data("settings.txt");
    ...
    public Configuration(String id) {
        ...
        this.handle = QuantumClient.getConfigDir().child(id + ".txt");
        this.id = id;
    ...
    public void reload() {
        ...
        try (BufferedReader reader = new BufferedReader(this.handle.reader())) {
            ...
            QuantumClient.LOGGER.error("Failed to reload configuration", e);
        }
    }
    ...
    public void save() {
        try (BufferedWriter writer = new BufferedWriter(this.handle.writer(false))) {
            ...
            QuantumClient.LOGGER.error("Failed to save configuration", e);
        }
    }
