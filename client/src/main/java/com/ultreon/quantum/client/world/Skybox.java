...
import static com.ultreon.quantum.util.Color.*;
...
public class Skybox {
    ...
    private static Color timeMix(int daytime, com.ultreon.quantum.util.Color dayTopColor, com.ultreon.quantum.util.Color nightTopColor) {
    ...
    private static Color sunRiseSetMix(int daytime, com.ultreon.quantum.util.Color sunRiseColor, com.ultreon.quantum.util.Color sunSetColor) {
