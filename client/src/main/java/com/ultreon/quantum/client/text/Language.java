package com.ultreon.quantum.client.text;
...
public class Language {
    ...
    public static String translate(String path, Object... args) {
        Language language = com.ultreon.quantum.client.text.LanguageManager.INSTANCE.get(com.ultreon.quantum.client.text.LanguageManager.getCurrentLanguage());
