...
package com.ultreon.gameprovider.quantum;

import net.fabricmc.api.EnvType;
import net.fabricmc.loader.impl.game.LibClassifier.LibraryType;

enum GameLibrary implements LibraryType {
	QUANTUM_VXL_CLIENT("com/ultreon/quantum/client/QuantumClient.class"),
	QUANTUM_VXL_SERVER("com/ultreon/quantum/server/dedicated/Main.class"),
