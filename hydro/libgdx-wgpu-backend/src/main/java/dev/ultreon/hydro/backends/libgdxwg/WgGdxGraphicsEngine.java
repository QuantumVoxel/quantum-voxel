...
import dev.ultreon.hydro.backends.libgdxwg.graphics.WgGdxSpriteBatch;
import dev.ultreon.hydro.backends.libgdxwg.graphics.WgGdxStencils;
...
public class WgGdxGraphicsEngine implements GraphicsEngine {
    private final Application app;
    private boolean vsync;
    private float clearRed, clearGreen, clearBlue, clearAlpha;

    public WgGdxGraphicsEngine(Application app) {
        this.app = app;
    }
    ...
    public SpriteBatch createSpiteBatch() {
        return new WgGdxSpriteBatch();
    }

    @Override
    public ShaderLanguage getShaderLanguage() {
        return ShaderLanguage.WebGL;
    }

    @Override
    public ShaderProgram createShaderProgram(String vertexPath, String fragmentPath) {
        throw new UnsupportedOperationException("Vertex/fragment shaders are not supported in WebGPU.");
    }

    @Override
    public ShaderProgram createShaderProgram(String vertexPath, String geometryPath, String fragmentPath) {
        throw new UnsupportedOperationException("Vertex/fragment/geometry shaders are not supported in WebGPU.");
    }
    ...
    @Override
    public boolean isCustomShaderSupported() {
        return false;
    }
