...
public class TcpNetworker implements ConnectionReceiver, Networker {
    ...
    public TcpNetworker(UltracraftServer server, @Nullable InetAddress host, int port) throws IOException {
        this.server = server;
        ...
        public void run() {
            ...
            while (running) {
                ...
                try(Socket accepted = networker.accept()) {
                    ...
                    UltracraftServer.LOGGER.error("Failed to accept connection.", e);
                }
            }
        }
        ...
        private void disconnect(ServerTcpConnection connection) {
            if (connections.contains(connection)) {
                ...
                try {
                    ...
                    UltracraftServer.LOGGER.error("Failed to close connection.", e);
                }
            }
        }
