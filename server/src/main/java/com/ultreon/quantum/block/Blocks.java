...
import com.ultreon.quantum.block.Block.Properties;
...
import com.ultreon.quantum.world.loot.RandomLoot;
...
public final class Blocks {
    ...
    public static final Block WATER = Blocks.register("water", new Block(new Properties().noCollision().noOcclude().transparent().fluid().hardness(120.0F)));
