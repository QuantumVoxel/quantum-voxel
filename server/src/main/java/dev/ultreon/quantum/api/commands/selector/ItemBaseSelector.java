...
import dev.ultreon.quantum.api.commands.error.InvalidIntegerError;
import dev.ultreon.quantum.api.commands.error.NeedPlayerError;
import dev.ultreon.quantum.api.commands.error.OverloadError;
import dev.ultreon.quantum.entity.player.Player;
import dev.ultreon.quantum.item.ItemStack;
import dev.ultreon.quantum.util.Numbers;
