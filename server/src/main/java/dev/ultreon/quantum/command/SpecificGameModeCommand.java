...
public class SpecificGameModeCommand extends Command {
    ...
    public SpecificGameModeCommand(GameMode gameMode) {
        ...
        switch (gameMode) {
            case SURVIVAL -> this.data().aliases("gms");
            case SPECTATOR -> this.data().aliases("gmsp");
            case BUILDER -> this.data().aliases("gmb");
            case BUILDER_PLUS -> this.data().aliases("gmbp");
            case ADVENTUROUS -> this.data().aliases("gma");
        }
    }
