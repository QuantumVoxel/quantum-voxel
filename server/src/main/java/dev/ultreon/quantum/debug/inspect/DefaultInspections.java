...
//        InspectionRoot.registerFormatter(Vec2f.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec2d.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec2i.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec3f.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec3d.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec3i.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec4f.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec4d.class, id -> id.x + "," + id.y);
//        InspectionRoot.registerFormatter(Vec4i.class, id -> id.x + "," + id.y);
