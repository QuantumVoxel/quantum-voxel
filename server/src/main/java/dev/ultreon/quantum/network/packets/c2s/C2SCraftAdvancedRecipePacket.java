...
public final class C2SCraftAdvancedRecipePacket implements Packet<InGameServerPacketHandler> {
    private final int typeId;
    private final NamespaceID recipeId;

    public C2SCraftAdvancedRecipePacket(int typeId, NamespaceID recipeId) {
        this.typeId = typeId;
    ...
    public boolean equals(Object obj) {
        ...
        C2SCraftAdvancedRecipePacket that = (C2SCraftAdvancedRecipePacket) obj;
    ...
    public String toString() {
        return "C2SCraftAdvancedRecipePacket[" +
               "typeId=" + typeId + ", " +
               "recipeId=" + recipeId + ']';
    }
