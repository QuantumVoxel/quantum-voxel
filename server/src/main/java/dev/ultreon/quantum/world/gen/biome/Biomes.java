...
public class Biomes {
    ...
    public static final Biome DRY_PLAINS = Biomes.register("dry_plains", Biome.builder()
            .noise(NoiseConfigs.GENERIC_NOISE)
            .domainWarping(seed -> new DomainWarping(QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_X.create(seed)), QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_Y.create(seed))))
            .temperatureRange(0.0f, 1.0f)
    ...
    public static final Biome ROCKY_PLAINS = Biomes.register("rocky_plains", Biome.builder()
            .noise(NoiseConfigs.GENERIC_NOISE)
            .domainWarping(seed -> new DomainWarping(QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_X.create(seed)), QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_Y.create(seed))))
            .temperatureRange(0.0f, 1.0f)
            .humidityRange(-1.0f, 0.0f)
    ...
    public static final Biome COLD_PLAINS = Biomes.register("cold_plains", Biome.builder()
            .noise(NoiseConfigs.GENERIC_NOISE)
            .domainWarping(seed -> new DomainWarping(QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_X.create(seed)), QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_Y.create(seed))))
            .temperatureRange(0.0f, 1.0f)
            .humidityRange(-1.0f, 0.0f)
    ...
    public static final Biome FROZEN_PLAINS = Biomes.register("frozen_plains", Biome.builder()
            .noise(NoiseConfigs.GENERIC_NOISE)
            .domainWarping(seed -> new DomainWarping(QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_X.create(seed)), QuantumServer.get().disposeOnClose(NoiseConfigs.LAYER_Y.create(seed))))
            .temperatureRange(-2.0f, -1.0f)
            .humidityRange(0.0f, 1.0f)
