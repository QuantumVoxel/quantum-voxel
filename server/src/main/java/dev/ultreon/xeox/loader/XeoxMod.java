...
public class XeoxMod implements Mod {
    ...
    private void populateScope(ScriptableObject scope) throws InternalError {
        ...
        scope.put("BlockProps", scope, BlockData.class);
        scope.put("Block", scope, Block.class);
        scope.put("Entity", scope, Entity.class);
        scope.put("Registry", scope, Registry.class);
        scope.put("Item", scope, Item.class);
        scope.put("ItemStack", scope, ItemStack.class);
        scope.put("EntityType", scope, EntityType.class);
        scope.put("Id", scope, Identifier.class);
        scope.put("registries", scope, new JSRegistries());
        scope.put("server", scope, (Supplier<QuantumServer>) QuantumServer::get);
        try {
